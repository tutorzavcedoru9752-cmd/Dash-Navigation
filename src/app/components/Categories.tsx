  ...
  return (
    ...
    <footer className={`relative z-10 mt-auto border-t transition-colors duration-200 ${
      ...
      <div className="mx-auto flex max-w-[1200px] flex-col items-center justify-between gap-5 px-5 py-8 sm:px-8 sm:py-12 md:flex-row md:gap-8">
        <p className={`text-center text-xs uppercase leading-5 tracking-widest md:text-left ${footerTextClass}`}>© 2024 Minimalist Dash. Designed for focus.</p>
        <div className="grid w-full grid-cols-3 items-center gap-2 text-center sm:flex sm:w-auto sm:flex-wrap sm:justify-center sm:gap-x-8 sm:gap-y-3">
          <RouterLink to="/docs" className={`whitespace-nowrap text-[10px] uppercase tracking-[0.12em] transition-colors sm:text-xs sm:tracking-widest ${hasWallpaper ? `${footerTextClass} opacity-80 hover:opacity-100` : 'text-gray-500 hover:text-gray-900 dark:text-gray-500 dark:hover:text-gray-200'}`}>Documentation</RouterLink>
          <a href="https://github.com/tutorzavcedoru9752-cmd/Dash-Navigation" target="_blank" rel="noreferrer" className={`whitespace-nowrap text-[10px] uppercase tracking-[0.12em] transition-colors sm:text-xs sm:tracking-widest ${hasWallpaper ? `${footerTextClass} opacity-80 hover:opacity-100` : 'text-gray-500 hover:text-gray-900 dark:text-gray-500 dark:hover:text-gray-200'}`}>GitHub</a>
          <RouterLink to="/privacy" className={`whitespace-nowrap text-[10px] uppercase tracking-[0.12em] transition-colors sm:text-xs sm:tracking-widest ${hasWallpaper ? `${footerTextClass} opacity-80 hover:opacity-100` : 'text-gray-500 hover:text-gray-900 dark:text-gray-500 dark:hover:text-gray-200'}`}>Privacy Policy</RouterLink>
        </div>
      </div>
    </footer>
  </>
